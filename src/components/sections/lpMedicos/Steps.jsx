  ...
  return (
    <>
      <SectionArea paddingtop={false}>
        <SectionWrapper>
          <SectionHeader
            miniTitle={contentMedicos.steps.sectionHeader.miniTag}
            className="text-center"
            sectionHeaderTitle={contentMedicos.steps.sectionHeader.title}
            sectionHeaderSubtitle={contentMedicos.steps.sectionHeader.subtitle}
            color="dark"
          />
          <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex text-center flex-col items-center desktop1:flex-wrap desktop1:flex-row justify-evenly w-full gap-[36px] tablet1:gap-[24px] font-mainFont mt-[42px] desktop1:mt-0">
                <div className="flex flex-col justify-center items-center w-[270px] hover:scale-110 transition mb-[32px] desktop1:mb-0">
                  <div className="bg-primary mb-[32px] p-[25px] flex justify-center items-center rounded-full h-[25px] w-[25px] text-white text-title3 font-semibold">
                    {contentMedicos.steps.cards.card1.number}
                  </div>
                  <h1 className="text-[21px] font-semibold mb-[24px]">
                    {contentMedicos.steps.cards.card1.title}
                  </h1>
                  <p className="text-[16px] opacity-65 text-center">
                    {contentMedicos.steps.cards.card1.description}
                  </p>
                </div>
                <div className="flex flex-col justify-center items-center w-[270px] hover:scale-110 transition mb-[32px] desktop1:mb-0">
                  <div className="bg-primary mb-[32px] p-[25px] flex justify-center items-center rounded-full h-[25px] w-[25px] text-white text-title3 font-semibold">
                    {contentMedicos.steps.cards.card2.number}
                  </div>
                  <h1 className="text-[21px] font-semibold mb-[24px]">
                    {contentMedicos.steps.cards.card2.title}
                  </h1>
                  <p className="text-[16px] opacity-65 text-center">
                    {contentMedicos.steps.cards.card2.description}
                  </p>
                </div>
                <div className="flex flex-col justify-center items-center w-[270px] hover:scale-110 transition mb-[32px] desktop1:mb-0">
                  <div className="bg-primary mb-[32px] p-[25px] flex justify-center items-center rounded-full h-[25px] w-[25px] text-white text-title3 font-semibold">
                    {contentMedicos.steps.cards.card3.number}
                  </div>
                  <h1 className="text-[21px] font-semibold mb-[24px]">
                    {contentMedicos.steps.cards.card3.title}
                  </h1>
                  <p className="text-[16px] opacity-65 text-center">
                    {contentMedicos.steps.cards.card3.description}
                  </p>
                </div>
              </div>
            </MotionDivDownToUp>
            <MotionDivDownToUp className="mt-[62px]">
              <Button
                ...
                label={contentMedicos.steps.ctaButtonLabel}
