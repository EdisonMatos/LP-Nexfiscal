...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${contentAposentadoria.about.bgImg})`,
          ...
          <SectionArea>
            <SectionWrapper>
              <div className="gap-y-[60px] flex flex-col items-center tablet2:flex-row tablet2:w-[100%] tablet2:justify-between tablet2:gap-[120px]">
                <img
                  src={contentAposentadoria.about.logo.logoImg}
                  alt={contentAposentadoria.about.logo.alt}
                  className="w-[90%] tablet2:w-[30%] desktop1:w-[40%]"
                />
                <div className="tablet2:w-[60%]">
                  <SectionHeader
                    className="text-center"
                    miniTitle={contentAposentadoria.about.sectionHeader.miniTag}
                    sectionHeaderTitle={
                      contentAposentadoria.about.sectionHeader.title
                    }
                    color=""
                    type="article"
                  />
                  <p className="font-mainFont mb-[36px]">
                    {contentAposentadoria.about.paragraph}
                  </p>
                  <div className="w-full">
                    <Button
                      aria-label={
                        contentAposentadoria.hero.textArea.ctaButtonAriaLabel
                      }
                      label={contentAposentadoria.about.buttonLabel}
                      buttonLink={contentAposentadoria.links.ctaWhatsapp}
                      animation
                      className=""
                      icon={
                        <svg
