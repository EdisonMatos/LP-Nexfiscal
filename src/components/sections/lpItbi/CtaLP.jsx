...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${contentItbi.cta.bgImg})`,
          ...
          <SectionArea className="">
            <SectionWrapper>
              <SectionHeader
                ...
                miniTitle={contentItbi.cta.sectionHeader.miniTag}
                sectionHeaderTitle={contentItbi.cta.sectionHeader.title}
                sectionHeaderSubtitle={contentItbi.cta.sectionHeader.subtitle}
                color=""
              />
              <Button
                aria-label={contentItbi.hero.textArea.ctaButtonAriaLabel}
                label={contentItbi.cta.buttonLabel}
