...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${contentItbi.about.bgImg})`,
          ...
          <SectionArea>
            <SectionWrapper>
              <div className="gap-y-[60px] flex flex-col items-center tablet2:flex-row tablet2:w-[100%] tablet2:justify-between tablet2:gap-[120px]">
                <img
                  src={contentItbi.about.logo.logoImg}
                  alt={contentItbi.about.logo.alt}
                  className="w-[90%] tablet2:w-[30%] desktop1:w-[40%]"
                />
                <div className="tablet2:w-[60%]">
                  <SectionHeader
                    className="text-center"
                    miniTitle={contentItbi.about.sectionHeader.miniTag}
                    sectionHeaderTitle={contentItbi.about.sectionHeader.title}
                    color=""
                    type="article"
                  />
                  <p className="font-mainFont mb-[36px]">
                    {contentItbi.about.paragraph}
                  </p>
                  <div className="w-full">
                    <Button
                      aria-label={contentItbi.hero.textArea.ctaButtonAriaLabel}
                      label={contentItbi.about.buttonLabel}
